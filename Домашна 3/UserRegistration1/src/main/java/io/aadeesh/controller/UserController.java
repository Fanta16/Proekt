...
public class UserController 
{
	...
	@PostMapping("/addUser")
	public ModelAndView addUser(@RequestParam("user_username") String user_username, User user)
	{
		ModelAndView mv=new ModelAndView("success");
		List<User> list=urepo.findByUsername(user_username);
	...
	if(auser!=null)
	{
		String uname=auser.getUser_username();
